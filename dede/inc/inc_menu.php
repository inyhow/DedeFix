...
<m:top item='9_' name='自动频道' display='block'>
  <m:item name='topic关键词' link='mulu_keywords_main.php'  rank='t_List,t_AccList' target='main'/>
  <m:item name='brand关键词' link='mulu_brand_main.php'  rank='t_List,t_AccList' target='main'/>
</m:top>  
